...
function humanError(e){
  if(e?.code==='auth/operation-not-allowed') return 'В Firebase включи Authentication → Sign-in method → Email/Password.';
  if(e?.code==='auth/unauthorized-domain') return 'Добавь этот домен в Firebase Authentication → Settings → Authorized domains.';
